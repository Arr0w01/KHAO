...
import static com.example.khao.CategoryView.cat;

public class FilterCatAdapter extends FirebaseRecyclerAdapter<Food, FilterCatAdapter.myviewholder>
{

    public FilterCatAdapter(@NonNull FirebaseRecyclerOptions<Food> options) {
        super(options);
    }
